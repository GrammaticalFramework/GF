...
lin absolve_V3from = mkV3 (mkV "absolve") "from" ;
...
lin adhere_V2to = mkV2 (mkV "adhere") "to" ;
...
lin ally_N = mkN "ally" ;
lin ally_V2with = mkV2 (mkV "ally") "with" ;
...
lin alternate_V2with = mkV2 (mkV "alternate") "with" ;
...
lin approve_V2of = mkV2 (mkV "approve") "of" ;
lin approximate_A = longA "approximate" ;
lin approximate_V2to = mkV2 (mkV "approximate") "to" ;
...
lin base_N = mkN "base" ;
lin base_V3loc =mkV3 (mkV "base") "loc" ;
...
lin blame_V3for =mkV3 (mkV "blame") "for" ;
...
lin characterize_V3_pred =mkV3 (mkV "characterize") "_pred" ;
lin charge_N = mkN "charge" ;
lin charge_V3with =mkV3 (mkV "charge") "with" ;
...
lin coin_N = mkN "coin" ;
lin coincide_V2with = mkV2 (mkV "coincide") "with" ;
...
lin collect_V3from =mkV3 (mkV "collect") "from" ;
...
lin communicate_V2with = mkV2 (mkV "communicate") "with" ;
...
lin compare_V3with =mkV3 (mkV "compare") "with" ;
...
lin depend_V2on = mkV2 (mkV "depend") "on" ;
...
lin despair_V2of = mkV2 (mkV "despair") "of" ;
...
lin die_V = (mkV "die") ;
lin die_N = mkN "die" ;
lin differ_V2from = mkV2 (mkV "differ") "from" ;
...
lin direct_V3to =mkV3 (mkV "direct") "to" ;
...
lin exit_N = mkN "exit" ;
lin exit_V2from = mkV2 (mkV "exit") "from" ;
...
lin extract_V3from =mkV3 (mkV "extract") "from" ;
...
lin fast_A = mkA "fast" ;
lin fasten_V3to =mkV3 (mkV "fasten") "to" ;
lin fat_N = massN "fat" ;
...
lin fur_N = mkN "fur" ;
lin furnish_V3with =mkV3 (mkV "furnish") "with" ;
...
lin gap_N = mkN "gap" ;
lin gape_V = (mkV "gape") ;
lin gape_V2at = mkV2 (mkV "gape") "at" ;
...
lin hop_V = (mkV "hop") ;
lin hope_N = mkN "hope" ;
lin hope_V2for = mkV2 (mkV "hope") "for" ;
...
lin hunger_V2for = mkV2 (mkV "hunger") "for" ;
...
lin important_A2 = longA2 "important" "" ;
lin impose_V3on =mkV3 (mkV "impose") "on" ;
...
lin integrate_V3with =mkV3 (mkV "integrate") "with" ;
...
lin introduce_V3to =mkV3 (mkV "introduce") "to" ;
...
lin join_V3to =mkV3 (mkV "join") "to" ;
...
lin laugh_V2at = mkV2 (mkV "laugh") "at" ;
...
lin lean_V2on = mkV2 (mkV "lean") "on" ;
lin leap_V = (mkV "leap") ;
...
lin liberate_V3from =mkV3 (mkV "liberate") "from" ;
...
lin link_N = mkN "link" ;
lin link_V3to =mkV3 (mkV "link") "to" ;
lin lion_N = mkN "lion" ;
lin lip_N = mkN "lip" ;
...
lin long_A = mkA "long" ;
lin long_V2for = mkV2 (mkV "long") "for" ;
lin longwinded_A = longA "longwinded" ;
lin look_N = mkN "look" ;
lin look_V3 =mkV3 (mkV "look") "" ;
lin look_V2for = mkV2 (mkV "look") "for" ;
lin loop_N = mkN "loop" ;
...
lin mix_V3with =mkV3 (mkV "mix") "with" ;
...
lin multiply_V3by =mkV3 (mkV "multiply") "by" ;
...
lin mutter_V2about = mkV2 (mkV "mutter") "about" ;
...
lin participate_V2in = mkV2 (mkV "participate") "in" ;
...
lin pass_V3to =mkV3 (mkV "pass") "to" ;
...
lin pore_N = mkN "pore" ;
lin pore_V2over = mkV2 (mkV "pore") "over" ;
...
lin present_V3with =mkV3 (mkV "present") "with" ;
lin preserve_V3from =mkV3 (mkV "preserve") "from" ;
...
lin prospect_V2for = mkV2 (mkV "prospect") "for" ;
lin prospective_A = longA "prospective" ;
lin prospector_N = mkN "prospector" ;
lin protect_V3from =mkV3 (mkV "protect") "from" ;
lin protest_N = mkN "protest" ;
lin protest_V2against = mkV2 (mkV "protest") "against" ;
...
lin reed_N = mkN "reed" ;
lin refer_V2to = mkV2 (mkV "refer") "to" ;
...
lin rely_V2on = mkV2 (mkV "rely") "on" ;
...
lin remove_V3from =mkV3 (mkV "remove") "from" ;
...
lin respond_V2to = mkV2 (mkV "respond") "to" ;
...
lin struggle_V2with = mkV2 (mkV "struggle") "with" ;
...
lin subject_V3to =mkV3 (mkV "subject") "to" ;
...
lin subtract_V3from =mkV3 (mkV "subtract") "from" ;
lin succeed_V2in = mkV2 (mkV "succeed") "in" ;
...
lin talk_V2about = mkV2 (mkV "talk") "about" ;
lin talk_N = mkN "talk" ;
lin tall_A = mkA "tall" ;
lin tame_A = mkA "tame" ;
...
lin temper_V3with =mkV3 (mkV "temper") "with" ;
...
lin term_V3ed =mkV3 (mkV "term") "ed" ;
lin term_N = mkN "term" ;
...
lin threaten_V3with =mkV3 (mkV "threaten") "with" ;
...
lin thrown_V3loc =mkV3 (mkV "thrown") "loc" ;
lin thrust_V3loc =mkV3 (mkV "thrust") "loc" ;
...
lin tin_N = mkN "tin" ;
lin tinker_V2with = mkV2 (mkV "tinker") "with" ;
lin tinker_N = mkN "tinker" ;
lin tip_N = mkN "tip" ;
lin tire_V2of = mkV2 (mkV "tire") "of" ;
...
lin vie_V2with = mkV2 (mkV "vie") "with" ;
lin view_V3_pred =mkV3 (mkV "view") "_pred" ;
lin view_N = mkN "view" ;
...
lin volunteer_V2for = mkV2 (mkV "volunteer") "for" ;
lin volunteer_N = mkN "volunteer" ;
lin vote_V2for = mkV2 (mkV "vote") "for" ;
lin vote_N = mkN "vote" ;
...
lin wise_A = mkA "wise" ;
lin wish_V2for = mkV2 (mkV "wish") "for" ;
