...
concrete SwadeshLexSwe of SwadeshLex = CategoriesSwe 
  ** open ResourceSwe, SyntaxSwe, ParadigmsSwe, VerbsSwe, 
  ...
  lin
    ...
    ear_N = mk2N "öra" "öron" ;   -- FIXME: WRONG
    earth_N = mk2N "jord" "jordar" ;
    egg_N = mk2N "ägg" "ägg" ;
    eye_N = mk2N "öga" "ögon" ;   -- FIXME: WRONG
...
--    mother_N = UseN2 mother_N2 ;
    ...
    snake_N = snake_N ;
    snow_N = mk2N "snö" "snöer" ; -- FIXME: WRONG
    star_N = star_N ;
    ...
    tooth_N = mk2N "tand" "tänder" ; -- FIXME: WRONG
    tree_N = tree_N ;
    water_N = water_N ;
