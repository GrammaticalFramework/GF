...
-- if you can find out what is its paradigm and then add it!
  ...
  conhecer_V = mkV (acontecer_Besch "conhecer") ;
  coalescer_V = mkV (acontecer_Besch "coalescer") ;
  comparecer_V = mkV (acontecer_Besch "comparecer") ;
  compadecer_V = mkV (acontecer_Besch "compadecer") ;
  contorcer_V = mkV (acontecer_Besch "contorcer") ;
  convalescer_V = mkV (acontecer_Besch "convalescer") ;
  convencer_V = mkV (acontecer_Besch "convencer") ;
  ...
  assediar_V = mkV (anunciar_Besch "assediar") ;
  ...
  esquecer_V = mkV (aquecer_Besch "esquecer") ;
  escarnecer_V = mkV (aquecer_Besch "escarnecer") ;
  escurecer_V = mkV (aquecer_Besch "escurecer") ;
  ...
  rogar_V = mkV (chegar_Besch "rogar") ;
  jogar_V = mkV (chegar_Besch "jogar") ;
  julgar_V = mkV (chegar_Besch "julgar") ;
  interrogar_V = mkV (chegar_Besch "interrogar") ;
  intrigar_V = mkV (chegar_Besch "intrigar") ;
  investigar_V = mkV (chegar_Besch "investigar") ;
  enxergar_V = mkV (chegar_Besch "enxergar") ;
  enrugar_V = mkV (chegar_Besch "enrugar") ;
  escorregar_V = mkV (chegar_Besch "escorregar") ;
  esmagar_V = mkV (chegar_Besch "esmagar") ;
  esfregar_V = mkV (chegar_Besch "esfregar") ;
  irrigar_V = mkV (chegar_Besch "irrigar") ;
  interligar_V = mkV (chegar_Besch "interligar") ;
  instigar_V = mkV (chegar_Besch "instigar") ;
  largar_V = mkV (chegar_Besch "largar") ;
  legalizar_V = mkV (chegar_Besch "legalizar") ;
  ligar_V = mkV (chegar_Besch "ligar") ;
  litigar_V = mkV (chegar_Besch "litigar") ;
  madrugar_V = mkV (chegar_Besch "madrugar") ;
  esfregar_V = mkV (chegar_Besch "esfregar") ;
  apagar_V = mkV (chegar_Besch "apagar") ;
  tragar_V = mkV (chegar_Besch "tragar") ;
  chover_V = mkV (chover_Besch "chover") ;
  começar_V = mkV (começar_Besch "começar") ;
  caçar_V = mkV (começar_Besch "caçar") ;
  coçar_V = mkV (começar_Besch "coçar") ;
  ...
  pintar_V = mkV (comprar_Besch "pintar") ;
  perguntar_V = mkV (comprar_Besch "perguntar") ;
  quebrar_V = mkV (comprar_Besch "quebrar") ;
  fechar_V = mkV (comprar_Besch "fechar") ;
  contar_V = mkV (comprar_Besch "contar") ;
  cortar_V = mkV (comprar_Besch "cortar") ;
  compilar_V = mkV (comprar_Besch "compilar") ;
  lutar_V = mkV (comprar_Besch "lutar") ;
  encontrar_V = mkV (comprar_Besch "encontrar") ;
  encomendar_V = mkV (comprar_Besch "encomendar") ;
  encalacrar_V = mkV (comprar_Besch "encalacrar") ;
  encaminhar_V = mkV (comprar_Besch "encaminhar") ;
  estampar_V = mkV (comprar_Besch "estampar") ;
  encanar_V = mkV (comprar_Besch "encanar") ;
  encampar_V = mkV (comprar_Besch "encampar") ;
  encantar_V = mkV (comprar_Besch "encantar") ;
  encapotar_V = mkV (comprar_Besch "encapotar") ;
  encarar_V = mkV (comprar_Besch "encarar") ;
  encarcerar_V = mkV (comprar_Besch "encarcerar") ;
  matar_V = mkV (comprar_Besch "matar") ;
  menosprezar_V = mkV (comprar_Besch "menosprezar") ;
  marchar_V = mkV (comprar_Besch "marchar") ;
  maravilhar_V = mkV (comprar_Besch "maravilhar") ;
  marombar_V = mkV (comprar_Besch "marombar") ;
  respirar_V = mkV (comprar_Besch "respirar") ;
  martirizar_V = mkV (comprar_Besch "martirizar") ;
  martelar_V = mkV (comprar_Besch "martelar") ;
  mascarar_V = mkV (comprar_Besch "mascarar") ;
  masturbar_V = mkV (comprar_Besch "masturbar") ;
  materializar_V = mkV (comprar_Besch "materializar") ;
  matizar_V = mkV (comprar_Besch "matizar") ;
  mazelar_V = mkV (comprar_Besch "mazelar") ;
  mecanizar_V = mkV (comprar_Besch "mecanizar") ;
  mediocrizar_V = mkV (comprar_Besch "mediocrizar") ;
  meditar_V = mkV (comprar_Besch "meditar") ;
  melar_V = mkV (comprar_Besch "melar") ;
  melhorar_V = mkV (comprar_Besch "melhorar") ;
  memorizar_V = mkV (comprar_Besch "memorizar") ;
  mencionar_V = mkV (comprar_Besch "mencionar") ;
  mensurar_V = mkV (comprar_Besch "mensurar") ;
  assoprar_V = mkV (comprar_Besch "assoprar") ;
  metralhar_V = mkV (comprar_Besch "metralhar") ;
  migrar_V = mkV (comprar_Besch "migrar") ;
  militar_V = mkV (comprar_Besch "militar") ;
  militarizar_V = mkV (comprar_Besch "militarizar") ;
  mimar_V = mkV (comprar_Besch "mimar") ;
  mimetizar_V = mkV (comprar_Besch "mimetizar") ;
  mirar_V = mkV (comprar_Besch "mirar") ;
  misturar_V = mkV (comprar_Besch "misturar") ;
  mobilizar_V = mkV (comprar_Besch "mobilizar") ;
  modelar_V = mkV (comprar_Besch "modelar") ;
  modernizar_V = mkV (comprar_Besch "modernizar") ;
  modular_V = mkV (comprar_Besch "modular") ;
  monopolizar_V = mkV (comprar_Besch "monopolizar") ;
  moralizar_V = mkV (comprar_Besch "moralizar") ;
  mostrar_V = mkV (comprar_Besch "mostrar") ;
  motivar_V = mkV (comprar_Besch "motivar") ;
  motorizar_V = mkV (comprar_Besch "motorizar") ;
  movimentar_V = mkV (comprar_Besch "movimentar") ;
  multar_V = mkV (comprar_Besch "multar") ;
  mundanizar_V = mkV (comprar_Besch "mundanizar") ;
  mutilar_V = mkV (comprar_Besch "mutilar") ;
  gostar_V = mkV (comprar_Besch "gostar") ;
  gabar_V = mkV (comprar_Besch "gabar") ;
  galopar_V = mkV (comprar_Besch "galopar") ;
  gangrenar_V = mkV (comprar_Besch "gangrenar") ;
  ganhar_V = mkV (comprar_Besch "ganhar") ;
  garimpar_V = mkV (comprar_Besch "garimpar") ;
  gastar_V = mkV (comprar_Besch "gastar") ;
  generalizar_V = mkV (comprar_Besch "generalizar") ;
  gerar_V = mkV (comprar_Besch "gerar") ;
  girar_V = mkV (comprar_Besch "girar") ;
  gravar_V = mkV (comprar_Besch "gravar") ;
  grelhar_V = mkV (comprar_Besch "grelhar") ;
  gritar_V = mkV (comprar_Besch "gritar") ;
  guardar_V = mkV (comprar_Besch "guardar") ;
  guerrilhar_V = mkV (comprar_Besch "guerrilhar") ;
  guinchar_V = mkV (comprar_Besch "guinchar") ;
  guisar_V = mkV (comprar_Besch "guisar") ;
  herdar_V = mkV (comprar_Besch "herdar") ;
  hibernar_V = mkV (comprar_Besch "hibernar") ;
  hipnotizar_V = mkV (comprar_Besch "hipnotizar") ;
  honrar_V = mkV (comprar_Besch "honrar") ;
  horripular_V = mkV (comprar_Besch "horripular") ;
  hospedar_V = mkV (comprar_Besch "hospedar") ;
  humanizar_V = mkV (comprar_Besch "humanizar") ;
  humilhar_V = mkV (comprar_Besch "humilhar") ;
  humorizar_V = mkV (comprar_Besch "humorizar") ;
  idealizar_V = mkV (comprar_Besch "idealizar") ;
  idolatrar_V = mkV (comprar_Besch "idolatrar") ;
  implementar_V = mkV (comprar_Besch "implementar") ;
  implantar_V = mkV (comprar_Besch "implantar") ;
  incrementar_V = mkV (comprar_Besch "incrementar") ;
  indignar_V = mkV (comprar_Besch "indignar") ;
  informar_V = mkV (comprar_Besch "informar") ;
  escutar_V = mkV (comprar_Besch "escutar") ;
  amar_V = mkV (comprar_Besch "amar") ;
  tirar_V = mkV (comprar_Besch "tirar") ;
  empurrar_V = mkV (comprar_Besch "empurrar") ;
  falar_V = mkV (comprar_Besch "falar") ;
  separar_V = mkV (comprar_Besch "separar") ;
  apertar_V = mkV (comprar_Besch "apertar") ;
  chupar_V = mkV (comprar_Besch "chupar") ;
  ensinar_V = mkV (comprar_Besch "ensinar") ;
  atar_V = mkV (comprar_Besch "atar") ;
  esperar_V = mkV (comprar_Besch "esperar") ;
  lavar_V = mkV (comprar_Besch "lavar") ;
  somar_V = mkV (comprar_Besch "somar") ;
  sensualizar_V = mkV (comprar_Besch "sensualizar") ;
  saltar_V = mkV (comprar_Besch "saltar") ;
  congelar_V = mkV (comprar_Besch "congelar") ;
  virar_V = mkV (comprar_Besch "virar") ;
  escavar_V = mkV (comprar_Besch "escavar") ;
  costurar_V = mkV (comprar_Besch "costurar") ;
  cantar_V = mkV (comprar_Besch "cantar") ;
  sentar_V = mkV (comprar_Besch "sentar") ;
  parar_V = mkV (comprar_Besch "parar") ;
  nadar_V = mkV (comprar_Besch "nadar") ;
  pensar_V = mkV (comprar_Besch "pensar") ;
  vomitar_V = mkV (comprar_Besch "vomitar") ;
  caminhar_V = mkV (comprar_Besch "caminhar") ;
  ...
  esfaquear_V = mkV (recear_Besch "esfaquear") ;
  escassear_V = mkV (recear_Besch "escassear") ;
  escarcear_V = mkV (recear_Besch "escarcear") ;
  escamotear_V = mkV (recear_Besch "escamotear") ;
  esfoguear_V = mkV (recear_Besch "esfoguear") ;
  estear_V = mkV (recear_Besch "estear") ;
  esbofetear_V = mkV (recear_Besch "esbofetear") ;
  espernear_V = mkV (recear_Besch "espernear") ;
  ...
  responder_V = mkV (vender_Besch "responder") ;
  beber_V = mkV (vender_Besch "beber") ;
  comer_V = mkV (vender_Besch "comer") ;
  temer_V = mkV (vender_Besch "temer") ;
  bater_V = mkV (vender_Besch "bater") ;
  benzer_V = mkV (vender_Besch "benzer") ;
  morder_V = mkV (vender_Besch "morder") ;
  aprender_V = mkV (vender_Besch "aprender") ;
  entender_V = mkV (vender_Besch "entender") ;
  envolver_V = mkV (vender_Besch "envolver") ;
  esbater_V = mkV (vender_Besch "esbater") ;
  remover_V = mkV (vender_Besch "remover") ;
  remeter_V = mkV (vender_Besch "remeter") ;
  remexer_V = mkV (vender_Besch "remexer") ;
  resolver_V = mkV (vender_Besch "resolver") ;
  reviver_V = mkV (vender_Besch "reviver") ;
  morrer_V = mkV (vender_Besch "morrer") ;
  viver_V = mkV (vender_Besch "viver") ;
  correr_V = mkV (vender_Besch "correr") ;
  coser_V = mkV (vender_Besch "coser") ;
  ...
  suar_V = mkV (suar_Besch "suar") ;
  flutuar_V = mkV (suar_Besch "flutuar") ;
  viajar_V = mkV (viajar_Besch "viajar") ;
  peneirar_V = mkV (peneirar_Besch "peneirar") ;
  cheirar_V = mkV (peneirar_Besch "cheirar") ;
  queixar_V = mkV (peneirar_Besch "queixar") ;
  queimar_V = mkV (peneirar_Besch "queimar") ;
