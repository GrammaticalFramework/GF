--# -path=.:src/finnish/stemmed:src/finnish:src/abstract:src/common:src/english:src/finnish/kotus:src/api

concrete TopDictFin of TopDict = CatFin ** open ParadigmsFin,
  (S = StructuralFin),
  (L = LexiconFin),
