...
lin run_VS = variants{} ;
lin run_V2 = mkV2 (mkV "marcher") | mkV2 (reflV (mkV "écouler")) | mkV2 (mkV I.courir_V2) ; -- tocheck
lin run_V = L.run_V ;
lin long_A = L.long_A ;
...
lin set_VV = variants{} ;
lin set_VS = variants{} ;
lin set_V2 = mkV2 (reflV (mkV "coucher")) | mkV2 (mkV I.mettre_V2) | mkV2 (mkV "régler") | mkV2 (mkV "fixer") | mkV2 (mkV "assigner") | mkV2 (mkV "enfoncer") | mkV2 (mkV "geler") ; -- tocheck
lin set_V = variants{} ;
lin help_VV = variants{} ;
lin help_VS = variants{} ;
lin help_V2V = mkV2V (mkV "aider") ; -- tocheck
lin help_V2 = variants{} ;
lin help_V = variants{} ;
lin every_Det = S.every_Det ;
lin home_N = mkN "maison" feminine | mkN "patrie" feminine ; -- tocheck
lin month_N = mkN "mois" masculine ; -- tocheck
lin side_N = mkN "face" feminine | mkN "côté" masculine | mkN "équipe" feminine | mkN "page" feminine ; -- tocheck
lin night_N = L.night_N ;
lin important_A = L.important_A ;
lin eye_N = L.eye_N ;
lin head_N = L.head_N ;
lin information_N = mkN "renseignement" masculine ; -- tocheck
lin question_N = L.question_N ;
lin business_N = mkN "entreprise" feminine | mkN "affaire" ; -- tocheck
...
lin power_N = mkN "électricité" feminine | mkN "puissance" feminine | mkN "pouvoir" masculine ; -- tocheck
lin money_N = mkN "argent" | mkN "liquide" masculine | mkN "argent" masculine ; -- tocheck
lin change_N = mkN "monnaie" feminine | mkN "changement" masculine ; -- tocheck
lin move_VV = variants{} ;
lin move_V2V = mkV2V (reflV (mkV I.mouvoir_V2)) | mkV2V (mkV I.émouvoir_V2) | mkV2V (mkV "déplacer") | mkV2V (mkV "déménager") | mkV2V (mkV "bouger") ; -- tocheck
lin move_V2A = variants{} ;
lin move_V2 = variants{} ;
lin move_V = variants{} ;
lin move_2_V = variants{} ;
lin move_1_V = variants{} ;
lin interest_N = mkN "intérêt" masculine ; -- tocheck
lin interest_4_N = variants{} ;
lin interest_2_N = variants{} ;
lin interest_1_N = variants{} ;
lin order_N = mkN "ordre" masculine | mkN "commande" feminine ; -- tocheck
lin book_N = L.book_N ;
lin often_Adv = mkAdv "souvent" ; -- tocheck
lin development_N = mkN "développement" masculine ; -- tocheck
lin young_A = L.young_A ;
lin national_A = mkA "national" ; -- tocheck
lin pay_V3 = mkV3 (mkV "payer") ; -- tocheck
lin pay_V2V = variants{} ;
lin pay_V2 = variants{} ;
lin pay_V = variants{} ;
lin hear_VS = variants{} ;
lin hear_V2V = mkV2V (mkV I.entendre_V2) ; -- tocheck
lin hear_V2 = L.hear_V2 ;
lin hear_V = variants{} ;
lin room_N = mkN "pièce" feminine | mkN "espace" feminine ; -- tocheck
lin room_1_N = variants{} ;
lin room_2_N = variants{} ;
lin whether_Subj = variants{} ;
lin water_N = L.water_N ;
lin form_N = mkN "formulaire" masculine | mkN "forme" feminine ; -- tocheck
lin car_N = L.car_N ;
lin other_N = variants{} ;
lin yet_Adv = mkAdv "encore" ; -- tocheck
lin yet_2_Adv = variants{} ;
lin yet_1_Adv = variants{} ;
lin perhaps_Adv = mkAdv "peut-être" ; -- tocheck
lin meet_V2V = mkV2V (mkV I.rejoindre_V2) | mkV2V (mkV "rencontrer") | mkV2V (mkV I.satisfaire_V2) | mkV2V (reflV (mkV I.rejoindre_V2)) | mkV2V (reflV (mkV "réunir")) | mkV2V (mkV "heurter") | mkV2V (reflV (mkV "retrouver")) ; -- tocheck
lin meet_V2 = variants{} ;
lin meet_V = variants{} ;
lin level_N = mkN "niveau" masculine ; -- tocheck
lin level_2_N = variants{} ;
lin level_1_N = variants{} ;
lin until_Subj = variants{} ;
lin though_Subj = variants{} ;
lin policy_N = mkN "police" feminine | mkN "politique" feminine ; -- tocheck
lin include_VV = variants{} ;
lin include_V2 = mkV2 (mkV I.inclure_V2) ; -- tocheck
lin include_V = variants{} ;
lin believe_VS = variants{} ;
lin believe_V2V = mkV2V (mkV I.croire_V2) ; -- tocheck
lin believe_V2 = variants{} ;
lin believe_V = variants{} ;
lin council_N = mkN "conseil" masculine ; -- tocheck
lin already_Adv = L.already_Adv ;
lin possible_A = mkA "#French#possible" | mkA "possible" ; -- tocheck
lin nothing_NP = S.nothing_NP ;
lin line_N = mkN "droite" feminine | mkN "ligne" feminine | mkN "ride" feminine ; -- tocheck
lin allow_VS = variants{} ;
lin allow_V2V = mkV2V (mkV "laisser") | mkV2V (mkV I.permettre_V2) ; -- tocheck
lin allow_V2 = variants{} ;
lin allow_V = variants{} ;
lin need_N = mkN "besoin" masculine ; -- tocheck
lin effect_N = mkN "effet" ; -- tocheck
lin big_A = L.big_A ;
lin use_N = mkN "usage" masculine | mkN "utilité" feminine ; -- tocheck
lin lead_VS = variants{} ;
lin lead_V2V = mkV2V (mkV "diriger") | mkV2V (mkV "mener") | mkV2V (mkV "guider") ; -- tocheck
lin lead_V2 = variants{} ;
lin lead_V = variants{} ;
lin stand_VV = variants{} ;
lin stand_VS = variants{} ;
lin stand_V2 = mkV2 (reflV (mkV "lever")) ; -- tocheck
lin stand_V = L.stand_V ;
lin idea_N = mkN "idée" feminine ; -- tocheck
lin study_N = mkN "étude" feminine ; -- tocheck
lin lot_N = mkN "bande" feminine | mkN "groupe" masculine | mkN "destin" masculine ; -- tocheck
lin live_VV = variants{} ;
lin live_V2 = mkV2 (mkV "habiter") | mkV2 (mkV I.vivre_V2) ; -- tocheck
lin live_V = L.live_V ;
lin job_N = mkN "tâche" feminine | mkN "travail" masculine | mkN "plastie" feminine ; -- tocheck
lin since_Subj = variants{} ;
lin name_N = L.name_N ;
lin result_N = mkN "résultat" masculine ; -- tocheck
lin body_N = mkN "corps" masculine | mkN "carrosserie" feminine | mkN "corpus" masculine | mkN "organisation" feminine | mkN "torse" masculine ; -- tocheck
lin happen_VV = variants{} ;
lin happen_V2 = mkV2 (mkV I.advenir_V) ; -- tocheck
lin happen_V = variants{} ;
lin friend_N = L.friend_N ;
lin right_N = mkN "droit" masculine | mkN "droite" feminine ; -- tocheck
lin least_Adv = variants{} ;
lin right_A = mkA "droit" | mkA "correct" ; -- tocheck
lin right_2_A = variants{} ;
lin right_1_A = variants{} ;
lin almost_Adv = mkAdv "presque" ; -- tocheck
lin much_Det = S.much_Det ;
lin carry_V2 = mkV2 (mkV I.retenir_V2) | mkV2 (mkV "porter") ; -- tocheck
lin carry_V = variants{} ;
lin authority_N = mkN "autorité" feminine ; -- tocheck
