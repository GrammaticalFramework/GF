...
lin however_Adv = mkAdv "hursomhelst" | mkAdv "däremot" ; ---- däremot
...
lin something_NP = S.mkNP (mkPN "någonting" neutrum) | S.mkNP (mkPN "något" neutrum) ;
...
lin presumably_Adv = mkAdv "antagligen" | mkAdv "troligen" ;
