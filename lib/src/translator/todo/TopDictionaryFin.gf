...
lin come_VA = mkVA (mkV "tulla") (mkPrep translative) ;
...
lin tell_1_V3 = mkV3 (mkV "kertoa") accusative (mkPrep allative) ;
...
lin choose_VS = mkVS "valita" ;
lin choose_V2V = mkV2V "valita" ;
lin choose_V2 = mkV2 "valita" ;
lin choose_V = mkV "valita" ;
...
lin argue_V2 = mkWV2 (k67 "perustella") ;
...
lin whatever_Det = mkDet Sg (mkN "vapaavalintainen") ; ---- mikä tahansa
...
lin please_Adv = mkAdv "mielellään" ; ---- cat
lin red_A = L.red_A ;
...
lin president_N = mkN "presidentti" ;
...
lin variety_1_N = mkN "valikoima" | mkN "vaihtelu" ; ---- split
...
lin agent_N = mkN "agentti" | mkN "edustaja" ;
