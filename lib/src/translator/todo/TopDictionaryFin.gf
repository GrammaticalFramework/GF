...
---- checked by IL till item_N in the BNC order
...
lin term_N = mkN "ehto" ; --- split mkN "termi"
...
lin read_VA = mkVA (mkV "lukea") (mkPrep partitive) ; ---- subcat
...
lin offer_VS = mkVS (mkV "tarjota") ; 
lin offer_V3 = mkV3 (mkV "tarjota") ;
lin offer_V2V = mkV2V (mkV "tarjota") ; ---- subcat
lin offer_V2 = mkV2 (mkV "tarjota") ; --f358
lin offer_V = mkV "tarjota" ; --f141
lin late_A = mkA "myöhäinen" ; --- split edesmennyt
lin voice_N = mkN "ääni" ; --f52
...
lin minute_N = mkN "minuutti" ; --- split mkN "muistiinpano"
...
lin send_VS = mkVS (mkV "lähettää") ; ---- subcat
...
lin understand_V2V = mkV2V (mkV "ymmärtää") genitive infPresPart ;
...
lin return_V2V = mkV2V (mkV "palauttaa") accusative infIllat ; ---- subcat
...
lin agree_V2 = mkV2 (mkV "suostua") (mkPrep illative) ; --- split mkV2 "kongruoida"
...
lin general_A = mkA "yleinen" ; --f417
lin century_N = mkN "vuosi" (mkN "sata") ; --f63
lin therefore_Adv = mkAdv "siksi" ;
lin father_N = mkN "isä" ;
lin section_N = mkN "osasto" ; --- split mkN "sektio" | mkN "leikkaus" ;
lin patient_N = mkWN "potilas" ; --f62
lin around_Adv = mkAdv "suunnilleen" | mkAdv "lähes" ; --f67
...
lin reach_VA = mkVA (mkV "saavuttaa") accusative ; ---- subcat
lin reach_V2V = mkV2V (mkV "saavuttaa") ; ---- subcat
...
lin experience_N = mkN "kokemus" ; --f69
lin death_N = mkN "kuolema" ;
lin soon_Adv = mkAdv "pian" ;
lin act_N = mkWN (k25 "toimi") ; --- split mkN "näytös"
lin sense_N = mkN "aisti" ; --- split mkN "järki"
...
lin walk_V = L.walk_V ;
lin die_V2 = mkV2 L.die_V ; ---- subcat
lin die_V = L.die_V ;
...
lin create_VV = mkVV (mkV "luoda") infIllat ; ---- subcat
...
lin sell_VS = mkVS (mkV "myydä") ; ---- subcat
lin sell_VA = mkVA (mkV "myydä") accusative ; ---- subcat
lin sell_V2 = mkV2 (mkV "myydä") ;
lin sell_V = mkV "myydä" ;
lin event_N = mkN "tapahtuma" ;
lin building_N = mkN "rakennus" ;
lin range_N = mkN "valikoima" ; --- split mkN "vuorijono" ; mkN "arvojoukko" ; mkN "kantama"
lin behind_Prep = S.behind_Prep ;
lin sure_A = mkA "varma" ;
lin report_VS = mkVS "raportoida" ;
lin report_V2V = mkV2V "raportoida" ; ---- subcat
lin report_V2 = mkV2 "raportoida" elative ;
lin report_V = mkV "raportoida" ;
lin pass_V2 = mkWV2 (mkV (mkV "päästää") "läpi") ; --- split ohittaa ; ojentaa ; viettää 
lin pass_V = mkV (mkV "päästä") "läpi" ; --- split mennä läpi ; vaipua
lin black_A = L.black_A ;
lin stage_N = mkN "vaihe" ; --- split mkN "näyttämö" ; mkWN (k5A "etappi") ; --f57
lin meeting_N = mkN "kokous" ;
lin sometimes_Adv = mkAdv "joskus" | mkWAdv (k99 "ajoittain") ; --f89
...
lin cause_VS = mkVS (mkV "aiheuttaa") ;
...
lin break_V = mkV "murtua" ; --f94
lin yesterday_Adv = mkAdv "eilen" ;
lin support_VV = mkVV (mkV "kannattaa") ; ---- subcat
lin support_V2 = mkV2 "kannattaa" partitive ;
lin window_N = L.window_N ;
lin account_N = mkN "selvitys" ;
lin explain_VS = mkVS (mkV "selittää") ; --f54
lin explain_V2 = mkV2 "selittää" ;
lin stay_VS = mkWVS (k52 "pysyä") ; ---- subcat
lin stay_VA = mkVA (mkV "pysyä") (mkPrep essive) ;
lin stay_V2 = mkV2 (mkV "jäädä") (mkPrep illative) | mkV2 (mkV "pysyä") (mkPrep essive) ;
lin stay_V = mkV "jäädä" | mkV "pysyä" ; --f88
...
lin air_N = mkN "ilma" ;
lin wife_N = L.wife_N ;
lin cover_VS = mkVS (mkV "peittää") ; ---- subcat
...
lin apply_V = mkV "soveltua" ; --f59
lin project_N = mkN "projekti" "projektin" "projekteja" ;
lin raise_V2V = mkV2V (mkV "nostaa") accusative infIllat ; ---- subcat
...
lin central_A = mkA "keskeinen" ; --f86
...
lin bear_V2 = mkV2 "kantaa" ; --- split mkV2 "sietää" partitive
lin bear_V = mkV "kantaa" ;
lin single_A = mkA "yksittäinen" ; --f102
...
lin reduce_V = mkV "vähentää" | mkV "vähentyä" ; --f56
lin establish_V2 = mkWV2 (mkV "perustaa") ;
lin wall_N = mkN "seinä" ; --- split mkN "muuri"
...
lin deal_V2 = mkV2 "käsitellä" partitive ; --- split mkV2 "jakaa" 
lin deal_V = mkV (mkV "käydä") "kauppaa" ; --- split mkV (mkV "tulla) "toimeen"
...
lin foreign_A = mkA "ulkomainen" ; --f404
...
lin serve_VV = mkVV (mkV "palvella") ; ---- subcat
lin serve_VS = mkVS (mkV "palvella") ; ---- subcat
...
lin wide_A = L.wide_A ;
lin occur_V = mkV "käydä" ; --f78
lin agreement_N = mkN "sopimus" ;
lin better_Adv = mkAdv "paremmin" ;
lin kill_V2 = L.kill_V2 ;
lin kill_V = mkV "tappaa" ;
lin act_VA = mkVA (mkV "käyttäytyä") (mkPrep "tavalla") ; ---- subcat ; "käyttäytyy X:n tavalla", wtf is this supposed to be anyway :-P "acts bad"?
lin act_V2V = mkV2V "käyttäytyä" ; ---- subcat
lin act_V2 = mkV2 "näytellä" ; --- split 
...
lin close_VS = mkVS "sulkea" ; ---- subcat
lin close_VA = mkVA (mkV "sulkea") (mkPrep translative) ; ---- subcat
lin close_V2V = mkV2V "sulkea" ; ---- subcat
...
lin love_V2V = mkV2V "rakastaa" ; ---- subcat
...
lin rise_VA = mkWVA (k66 "nousta") "ylös" ; ---- subcat
...
lin prepare_VS = mkWVS (k52A "varautua") ;
...
lin prove_V2V = mkV2V (mkV "todistaa") genitive infPresPart ;
...
lin fine_A = mkA "hieno" ;  --- split mkWA (k43 "ohut") ;
lin plant_N = mkN "kasvi" ; --- split mkN "laitos"
lin pressure_N = mkN "paine" ;
lin response_N = mkN "vastaus" ;
lin catch_VS = mkVS (mkV "ymmärtää") ; --ymmärsin että XYZ
lin catch_V2 =  mkV2 (mkV (mkV "saada") "kiinni") | mkV2 (mkV (mkV "ottaa") "kiinni") ;
lin catch_V = mkV (mkV "ottaa") "kiinni" | mkV "napata" ;
lin street_N = mkWN (k1A "katu") ; --f71
lin pick_V2 = mkV2 "poimia" partitive | mkV2 "kerätä" partitive ;
lin pick_V = mkV "poimia" | mkV "kerätä" | mkV "valita" | mkV "nyppiä" ; --f69
lin performance_N = mkN "suoritus" ; --f187
...
lin suppose_V2V = mkV2V (mkV "olettaa") genitive infPresPart ;
lin suppose_V2 = mkV2 "arvata" ;
lin rest_N = mkWN (k1A "lepo") ; --f110
lin instead_Adv = mkAdv "sen sijaan" ;
lin wear_V2 = mkV2 "kuluttaa" ; --- split mkV2 (mkV (mkV "pitää") "päällä") ;
...
lin success_N = mkN "menestys" ; --f93
...
lin arrive_V2 = mkV2 "saapua" illative | mkV2 (mkV (mkV "tulla") "perille") (mkPrep illative) ;
...
lin choice_N = mkN "valinta" ; --f68
lin refer_V2 = mkV2 (mkV "viitata") illative ;
lin refer_V = mkV "viitata" ; --f55
lin feature_N = mkN "piirre" ; --- split mkWN (compoundN "erikois" (k6 "artikkeli")) ;
...
lin training_N = mkN "harjoitus" ; --f54
lin present_V2 = mkV2 "esittää" ;
lin association_N = mkN "järjestö" ; --- split mkN "assosiaatio" ;
...
lin task_N = mkN "tehtävä" | mkWN (k25 "toimi") ; --f67
...
lin function_N = mkN "funktio" ; --- split mkN "tehtävä" ---ARB mkWN (k5 "rooli") ;
...
lin technology_N = mkN "tekniikka" ; --- split mkN "teknologia"
...
lin force_V2V = mkV2V (mkV "pakottaa") accusative infIllat ; ---ARB (k53A "tyrkyttää") ; --f71
lin force_V2 = mkV2 "pakottaa" ;
lin force_V = mkV "pakottaa" ;
lin answer_N = mkN "vastaus" ;
lin compare_V2 = mkV2 "verrata" partitive | mkV2 "vertailla" partitive ; --f60
...
lin indicate_V = mkWV (k53A "osoittaa") ;
...
lin previous_A = mkA "edellinen" ; --f408
...
lin fight_V2V = mkWV2V (k67 "taistella") ; ---- subcat
...
lin design_V2V = mkV2V (mkV "suunnitella") accusative infIllat ; ---- subcat
...
lin determine_V2 = mkV2 "päättää" | mkV2 "määrätä" ; --- split mkV2 "ratkaista"
lin determine_V = mkV "määrätä" | mkV "päättää" ; --mkV "ratkaista" ; 
lin generally_Adv = mkAdv "yleisesti" ;
lin daughter_N = mkN "tytär" ;
lin exist_V2V = mkV2V exist_V ; ---- subcat
...
lin total_A = mkA "totaalinen" ; --f237
...
lin assume_V2 = mkV2 "olettaa" ; --- split omaksua, ottaa
lin assume_V = mkV "olettaa" ;
...
lin replace_VV = mkWVV (k56A "vaihtaa") ; ---- subcat
...
lin affair_N = mkWN (k1A "juttu") ; --- split
...
lin item_N = mkN "kohta" ; --- split mkN "esine" | mkN "objekti"
---- checked by IL till item_N in the BNC order
...
lin dine_V2 = mkV2 (mkV (mkV "syödä") "päivällistä") ; --UNCHK
