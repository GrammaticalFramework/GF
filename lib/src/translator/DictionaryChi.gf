...
lin scramble_V2V = variants{}; -- mkVV "争夺" ;
...
lin student_N = L.student_N ; ---- split masc/fem
...
lin telex_N = mkN "电传" ;
lin tell_1_V3 = mkV3 "告诉" ;--"说" ; ----
lin tell_2_V3 = mkV3 "告诉" ;--"说" ; ----
lin tell_V = mkV "告诉" ;
lin tell_V2 = mkV2 "告诉" ;
...
lin volunteer_V2V = variants{}; -- mkV2 "自愿" ;
